...
<xsl:template match="/rss">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/feeling-responsive"><img src="http://localhost:4000/feeling-responsive/assets/img/small_32.png"> Utah Agile</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/feeling-responsive/design/">Join a Meetup</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/feeling-responsive/design/grid/">Product Owner Quarterly</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/typography/typography/">Scrum Master Monthly</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/feeling-responsive/design/page/"></a></li>
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/headers/">Host a Meetup</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/documentation/">Be a Sponsor</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/documentation/">Event Calendar</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/blog/">Blog</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000/feeling-responsive/blog/">About</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/feeling-responsive/design/">Debug</a>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/feeling-responsive/" title="Utah Agile – Mindset Elevated">
				<img src="http://localhost:4000/feeling-responsive/assets/img/logo.png" alt="Utah Agile – Mindset Elevated">
			</a>
